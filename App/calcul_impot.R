...
calcul_impot <- function(annee_rev, sit, rev1, rev2, rfr1, rfr2, bareme, plaf_qf, nb_parts, nb_payeurs, decote, coeff_decote, reduc){
  ...
  Indicateurs <- c("mt_impot_brut", "mt_impot_brut_ff","Avantage_QF", "Avantage_decote", "Avantage_reduc", "impot_net")
  Valeurs <- c(mt_impot_brut, mt_impot_brut_ff, avantage_QF, avantage_fin_decote, ifelse(annee_rev == 2019, avantage_fin_reduc, 0), impot_net)
